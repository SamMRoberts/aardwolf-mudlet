...
aard interface density compact|comfortable
aard interface scale 90|100|115|130
aard interface details show|hide|toggle|refresh|status
aard interface action add|edit|remove|move|list]])
end
