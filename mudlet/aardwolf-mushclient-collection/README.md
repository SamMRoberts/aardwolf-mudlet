...
- `aardwolf-interface` — responsive Geyser sidebar and bottom gauge HUD with a numeric diminishing tick gauge, embedded native mapper, and an expanded-only character-details column
