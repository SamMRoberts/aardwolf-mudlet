...
def main() -> None:
    ...
    for package in FEATURE_PACKAGES:
        ...
        expected_version = "1.3.2" if package == "aardwolf-interface" else "1.1.0" if package in {"aardwolf-gmcp-diagnostics", "aardwolf-tick"} else "1.0.1" if package == "aardwolf-map" else "1.0.0"
    ...
    with zipfile.ZipFile(suite_package_path) as archive:
        ...
        assert "version = [[1.3.2]]" in suite_config
