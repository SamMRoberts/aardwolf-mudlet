...
class SpellupTests(unittest.TestCase):
    ...
    def test_sequential_sync_tags_defensive_copies_and_display_only_expiry(self):
        ...
        lua.execute("""
          ...
          assert(spells:isFresh() and commandCount('spellup learned retry')==0 and #commands==3)
        """)
    ...
    def test_deltas_recoveries_and_reconnect_reset(self):
        ...
        lua.execute("""
          synchronize()
          assert(commandCount('slist recoveries noprompt')==0)
    ...
    def test_inactive_recovery_catalog_rows_are_not_tracked(self):
        ...
        lua.execute("""
          ...
          recoveryRows({'0,Augmentation,0','15,Detect magic recovery,20',
