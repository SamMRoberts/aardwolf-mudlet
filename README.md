...
The supplied **active campaign info/check** and **inactive/available** responses are supported.
An active Refresh collects info and then remaining targets, preserving rewards and the
reported deadline. Global Quest formats and campaign terminal events remain pending;
